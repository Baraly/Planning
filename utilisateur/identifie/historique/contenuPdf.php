...
$donnees = $bdd->query("SELECT * FROM User WHERE id = '$userId'")->fetch();
...
$request = $bdd->query("SELECT * FROM Horaire WHERE MONTH(datage) = '$mois' AND YEAR(datage) = '$annee' AND idUser = '$userId' AND idHoraire NOT IN (SELECT idHoraire FROM HorairePoubelle) ORDER BY datage");
